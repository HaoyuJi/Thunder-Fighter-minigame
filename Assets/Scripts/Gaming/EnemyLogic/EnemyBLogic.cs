...
public class EnemyBLogic : MonoBehaviour
{
    ...
    private void TestFire()
    {
        ...
        {
            Instantiate(bulletPrefab, this.firePoint.position + Vector3.right * fire_way[i], Quaternion.Euler(0, 0, 0), null); // 产生子弹
        }
